...
class AnnixNativeImpl implements AnnixNative {
  ...
  factory AnnixNativeImpl(ExternalLibrary dylib) =>
      AnnixNativeImpl.raw(AnnixNativePlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory AnnixNativeImpl.wasm(FutureOr<WasmModule> module) =>
      AnnixNativeImpl(module as ExternalLibrary);
...
class AnnixNativeWire implements FlutterRustBridgeWireBase {
  ...
  AnnixNativeWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  AnnixNativeWire.fromLookup(
